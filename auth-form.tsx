...
import { Eye, EyeOff, Loader2, Mail, Lock, User, Sparkles, Github } from "lucide-react";
...
export function AuthForm({ mode, token }: AuthFormProps) {
  ...
  const titles: Record<AuthFormProps["mode"], { heading: string; subheading: string }> = {
    login: {
      heading: "Welcome back",
      subheading: "Sign in to your Cavrix AI account",
    },
    signup: {
      heading: "Create an account",
      subheading: "Get started with Cavrix AI",
    },
    "forgot-password": {
  ...
  const { heading, subheading } = titles[mode];
              ...
              <div className="flex items-center justify-between">
                ...
                {mode === "login" && (
                  <Link
                    ...
                    className="text-xs text-cavrix-400 hover:text-cavrix-300 transition-colors"
                  >
                    Forgot password?
                  </Link>
                )}
        ...
        <div className="mt-6 text-center text-sm text-slate-400">
          {mode === "login" && (
            <p>
              ...
              <Link href="/signup" className="font-medium text-cavrix-400 hover:text-cavrix-300 transition-colors">
                Sign up
              </Link>
            </p>
          )}
          {mode === "signup" && (
            <p>
              ...
              <Link href="/login" className="font-medium text-cavrix-400 hover:text-cavrix-300 transition-colors">
                Sign in
              </Link>
            </p>
          )}
